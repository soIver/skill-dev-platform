...
export default function Login() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // логика входа (API-запрос и обновление Zustand)
        console.log("Вход:", { email, password });
    };

    const handleGitHubLogin = () => {
        // логика OAuth для GitHub (редирект на GitHub API)
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="auth-panel">
                <h1 className="panel-header">Вход</h1>
                ...
                <div className="mt-4 text-center text-sm text-gray-600">
                    Нет аккаунта? <Link to="/auth/registration" className="hyperlink">Зарегистрироваться</Link>
                </div>
            </div>
        </div>
    );
